	...
	<div class="container mx-auto">
		...
		<div class="search-form-box mt-2 px-4">
			<form action="" class="grid gap-2">
				...
				<div class="form-control">
					...
					<input value="${param.searchKeyword}" class="input input-bordered text-base" name="searchKeyword" type="text" placeholder="검색어를 입력해주세요." maxlength="10" />
				</div>
		...
		<div class="articles mt-2">
			...
			<c:forEach items="${articles}" var="article">
				<div>
					ID : ${article.id}<br>
					CURRENT DATE : ${article.currentDate}<br>
		...
		<div class="pages">
			<c:forEach var="i" begin="1" end="${totalPage }">
				...
				<a class="test-lg ${page == i ? 'text-red-500' : ''}" href="${url}">${i}</a>
			</c:forEach>
		</div>
	</div>
</div>
